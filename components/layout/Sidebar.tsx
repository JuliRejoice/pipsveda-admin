...
import { LayoutDashboard, Users, BookOpen, Bot, MessageCircle, CreditCard, Bell, UserPlus, Settings, ChevronLeft, ChevronRight, Mail, MessageSquare, User, LogOut, ChevronDown, Settings as SettingsIcon, Waves, Gift, LayoutList, FileVideo } from "lucide-react";
    ...
    <div className={cn("bg-[#f5f5f5] transition-all duration-300 flex flex-col h-screen sticky top-0", isCollapsed ? "w-16" : "w-[280px]")}>
      ...
      <div className="flex items-center justify-between px-4 border-b relative">
        <div className={cn("flex items-center space-x-2 transition-all duration-400 ease-in-out", isCollapsed ? "w-full justify-center" : "")}>
          ...
          {!isCollapsed && <h2 className="text-xl font-bold text-foreground">Pips Veda</h2>}
        </div>
      </div>
